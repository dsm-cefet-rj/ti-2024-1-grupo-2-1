import animalActionType from "../favanimal/action-type";
...
const animalReducer = ( state = estadoInicial, action) => {
    switch(action.type) {
//         case animaisActionType.ADDED_TO_FAV:
//             const animalJaFavoritado = state.animais.some(
...
//             return{
//                 ...state,
//                 animais: [...state.animais,{...action.payload.isfav, quantity: 1}],
